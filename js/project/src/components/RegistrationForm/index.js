  ...
  return (
      <Container sx={{ pt: '15vh', pb: '25px', minHeight: '89.4vh', width: '100%' }}>
        ...
        <TextField
            ...
            />
              <Button sx={{ mt: '1rem', mr: '0.5rem', color: '#fff', bgcolor: 'primary', "&:hover": {bgcolor: 'secondary', color: '#fff'} }} variant='contained' disabled={!(login && password)} onClick={() => {onReg(login, password)}}>Регистрация</Button>&nbsp;
