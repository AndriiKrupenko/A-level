...
import { actionAdById, actionSaveAd, backURL } from '../../actions';
        ...
        <Container sx={{ display: 'flex', justifyContent: 'center', pt: '3vh' }}>
            ...
            <Box sx={{ width: '43%', textAlign: 'center', pt: '0.5rem' }}>
                <Box sx={{ backgroundColor: '#E9DFC4', border: '3px solid #402217', borderRadius: '10px', pt: '1rem', pb: '1rem' }}>
                    {(img && img[0] && img[0].url) ? <img style={{ maxWidth: '90%', maxHeight: '35vh', borderRadius: '10px', boxShadow: '3px 3px 3px #402217' }} src={`${backURL}/` + img[0].url} alt='adImg' /> :
